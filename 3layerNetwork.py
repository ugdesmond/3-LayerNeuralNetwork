...
class NeuralNetwork():
    ...
    def print_weights(self):
        print("   Layer 1 (3 inputs, 5 neurons): ")
        print (self.layer1.synaptic_weights)
        print("  Layer 2 ( 5 inputs,with 4 neurons):")
        print (self.layer2.synaptic_weights)
        print("  Layer 3 ( 4 inputs,1 neuron):")
...
if __name__ == "__main__":
    ...
    # Create layer 2 (a 4 neuron with 5 inputs)
    ...
    hidden_state,hidden_state2, output = neural_network.think(array([1,0, 0]))
    print (output)
